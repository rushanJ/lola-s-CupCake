...
public class UserHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("STATE","error while reading file");;
        }
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://10.0.2.2/cakeshop/API/itemList.json";
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        contact.put("price","Price : Rs "+ price+".00");
                        contact.put("description", "Description: "+description);
...
//                    Toast.makeText(UserHome.this,contactList, Toast.LENGTH_SHORT).show();
       ...
       public void orderItems(String user, String item){
           ...
           String url = "http://critssl.com/cakeshop/API/orderItem.php?user="+user+"&item="+item;
...
//                                mTextViewResult.setText("success: "+success);
                                   if (success.equals("true")) {
                                       ...
                                       AlertDialog.Builder a_builder = new AlertDialog.Builder(UserHome.this);
                                       a_builder.setMessage("Order Placed Successfully !")
                                               .setCancelable(false)
                                       ...
                                       AlertDialog.Builder a_builder = new AlertDialog.Builder(UserHome.this);
                                       a_builder.setMessage("Unable to place Order !")
                                               .setCancelable(false)
...
//                            mTextViewResult.setText(myResponse);
                   ...
                   else Log.d("STATE","Error in http");
               }
           });
       }
    }
